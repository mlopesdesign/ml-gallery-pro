...
PLUGIN_FILE="$ROOT/ml-gallery-pro/ml-gallery-pro.php"
README_FILE="$ROOT/ml-gallery-pro/readme.txt"
...
const=$(grep -E "define\(\s*'MLGP_VERSION'" "$PLUGIN_FILE" | head -1 | sed -E "s/.*'MLGP_VERSION',\s*'([0-9.]+)'.*/\1/")
