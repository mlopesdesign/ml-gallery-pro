...
final class Admin {
		...
		wp_localize_script(
			...
			[
				...
				'pageUrls'  => [
					...
					'license'   => $this->get_admin_page_url( 'mlgp-license' ),
				],
				'formEndpoints' => [
	...
	private function detect_page(): string {
		...
		return in_array( $page, [ 'mlgp-dashboard', 'mlgp-galleries', 'mlgp-add-images', 'mlgp-albums', 'mlgp-tags', 'mlgp-settings', 'mlgp-license' ], true ) ? $page : 'mlgp-dashboard';
	}
	...
	private function get_page_meta( string $page ): array {
		$pages = [
			...
			'mlgp-license' => [
				'page'        => 'license',
				'title'       => __( 'Licenca', 'ml-gallery-pro' ),
				'description' => __( 'Gerencie o serial, o trial e o estado da licenca desta instalacao sem alterar o motor de validacao.', 'ml-gallery-pro' ),
			],
		];
	...
	private function get_shell_tabs( string $current_page ): array {
		$items = [
			...
			[
				'label' => __( 'Licenca', 'ml-gallery-pro' ),
				'page'  => 'mlgp-license',
			],
		];
