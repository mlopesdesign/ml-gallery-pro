	...
	public function save_settings(): void {
		...
		$settings = $this->repository->save_settings(
			[
				...
				'album_nav_button_enabled' => $this->post( 'album_nav_button_enabled' ),
				'album_nav_button_bg_color' => $this->post( 'album_nav_button_bg_color' ),
				'album_nav_button_text_color' => $this->post( 'album_nav_button_text_color' ),
				'album_nav_button_border_color' => $this->post( 'album_nav_button_border_color' ),
				'album_nav_button_hover_bg_color' => $this->post( 'album_nav_button_hover_bg_color' ),
				'album_nav_button_hover_text_color' => $this->post( 'album_nav_button_hover_text_color' ),
				'album_nav_button_align' => $this->post( 'album_nav_button_align' ),
				'album_nav_button_position' => $this->post( 'album_nav_button_position' ),
