 ...
 * Update URI: https://github.com/mlopesdesign/ml-gallery-pro
...
function mlgp_maybe_flush_rewrite_rules(): void {
	...
	$flushed_version = (string) get_option( 'mlgp_rewrite_rules_version', '' );

	if ( MLGP_VERSION === $flushed_version ) {
		return;
	}

	flush_rewrite_rules( false );
	update_option( 'mlgp_rewrite_rules_version', MLGP_VERSION );
}

add_action( 'admin_init', 'mlgp_maybe_flush_rewrite_rules', 99 );
