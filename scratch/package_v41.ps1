...
$destZip = "d:\ANTIGRAVITY\ml-gallery-pro\ml-gallery-pro-v0.22.43.zip"
...
# 1. Add recursive folder entries first (important for some extractors)
...
foreach ($dir in $dirs) {
    # Relative path from inside ml-gallery-pro
